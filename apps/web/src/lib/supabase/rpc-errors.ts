...
// supabase/migrations/0003_team_join_functions.sql. Postgres surfaces these
// as the `message` on a PostgrestError; map them to i18n keys so a raw
// exception string never reaches the UI.
